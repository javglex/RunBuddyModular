...
import com.skymonkey.core.presentation.designsystem.RunbuddyBlack
...
private fun ActionButtonPreview() {
    ActionButton(text = "Button", isLoading = false)
}

@Preview
@Composable
private fun OutlinedActionButtonPreview() {
    OutlinedActionButton(text = "Button", isLoading = false)
}